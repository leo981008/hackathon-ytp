...
function App() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-300">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-slate-900/80 backdrop-blur-md border-b border-cyan-900/50 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              <MapPin className="w-6 h-6 text-cyan-400 drop-shadow-[0_0_8px_rgba(34,211,238,0.8)]" />
              <span className="font-bold text-xl tracking-tight text-slate-100">Data.Taipei<span className="text-cyan-400 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">SmartTravel</span></span>
            </div>
            <div className="hidden md:flex gap-8 text-sm font-medium text-slate-400">
              <a href="#phase1" className="hover:text-cyan-400 transition-colors">行前規劃</a>
              <a href="#phase2" className="hover:text-cyan-400 transition-colors">旅程應變</a>
              <a href="#phase3" className="hover:text-cyan-400 transition-colors">在地體驗</a>
              <a href="#phase4" className="hover:text-cyan-400 transition-colors">數位典藏</a>
            </div>
            <button className="bg-cyan-500/10 border border-cyan-500 hover:bg-cyan-500/20 text-cyan-400 px-5 py-2 rounded-full text-sm font-medium transition-colors shadow-[0_0_10px_rgba(34,211,238,0.2)] hover:shadow-[0_0_15px_rgba(34,211,238,0.4)]">
              開始規劃
            </button>
          </div>
        </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/50 border border-cyan-500/30 text-cyan-400 text-sm font-medium mb-8 shadow-[0_0_15px_rgba(34,211,238,0.15)]">
            <span className="flex h-2 w-2 rounded-full bg-cyan-400 animate-pulse shadow-[0_0_8px_rgba(34,211,238,1)]"></span>
            整合臺北市政府 Data.Taipei 開放資料
          </div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8">
            <span className="block text-slate-100 mb-2 drop-shadow-md">臺北智慧旅遊</span>
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500 drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]">
              你的專屬 AI 導遊
            </span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <button className="inline-flex items-center justify-center gap-2 bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 px-8 py-4 rounded-full text-lg font-medium border border-cyan-500/50 transition-all shadow-[0_0_15px_rgba(34,211,238,0.2)] hover:shadow-[0_0_25px_rgba(34,211,238,0.4)]">
              <Compass className="w-5 h-5" />
              立即生成行程
            </button>
            <button className="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-slate-300 px-8 py-4 rounded-full text-lg font-medium border border-slate-700 transition-all shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-32">
        ...
        <section id="phase1" className="scroll-mt-24">
          <div className="mb-12 border-l-4 border-cyan-500 pl-4">
            <h2 className="text-3xl font-bold text-slate-100 mb-4 drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]">階段一：行前智慧化行程規劃</h2>
            <p className="text-lg text-slate-400">運用 AI 模型深度理解個人偏好，並結合即時天氣與全球交通路網，打造最完美的旅遊藍圖。</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            />
            <FeatureCard
            icon={<PlaySquare className="w-6 h-6 text-cyan-400" />}
              title="AI 多重行程預演模擬"
        ...
        <section id="phase2" className="scroll-mt-24">
          <div className="mb-12 border-l-4 border-indigo-500 pl-4">
            <h2 className="text-3xl font-bold text-slate-100 mb-4 drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]">階段二：旅程中即時情境感知與動態應變</h2>
            <p className="text-lg text-slate-400">無縫串接臺北市各項即時監測數據，提供最即時的交通、人潮與安全應變方案。</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
            ...
            />
            <FeatureCard
              icon={<Train className="w-6 h-6 text-indigo-400" />}
        ...
        <section id="phase3" className="scroll-mt-24">
          <div className="mb-12 border-l-4 border-emerald-500 pl-4">
            <h2 className="text-3xl font-bold text-slate-100 mb-4 drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]">階段三：在地文化沉浸式互動體驗</h2>
            <p className="text-lg text-slate-400">透過擴增實境與在地文化知識庫，將臺北百年歷史與藝文活動轉化為深度的互動旅遊。</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
        ...
        <section id="phase4" className="scroll-mt-24 pb-24">
          <div className="mb-12 border-l-4 border-amber-500 pl-4">
            <h2 className="text-3xl font-bold text-slate-100 mb-4 drop-shadow-[0_0_8px_rgba(255,255,255,0.1)]">階段四：旅遊回憶自動化彙整與數位典藏</h2>
            <p className="text-lg text-slate-400">旅行結束後，由 AI 自動將照片與軌跡轉化為精美日誌，永遠珍藏專屬回憶。</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
...
function FeatureCard({
  ...
  const colorStyles = {
    blue: "bg-cyan-950/40 border-cyan-500/30",
    indigo: "bg-indigo-950/40 border-indigo-500/30",
  ...
  const hoverStyles = {
    blue: "hover:border-cyan-500/50 hover:shadow-[0_0_15px_rgba(34,211,238,0.2)]",
    indigo: "hover:border-indigo-500/50 hover:shadow-[0_0_15px_rgba(99,102,241,0.2)]",
    emerald: "hover:border-emerald-500/50 hover:shadow-[0_0_15px_rgba(16,185,129,0.2)]",
    amber: "hover:border-amber-500/50 hover:shadow-[0_0_15px_rgba(245,158,11,0.2)]"
  }

  return (
    <div className={`bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-800 transition-all duration-300 ${hoverStyles[color]}`}>
      <div className={`inline-flex items-center justify-center p-3 rounded-xl mb-4 border ${colorStyles[color]} shadow-inner`}>
        {icon}
      </div>
      <h3 className="text-xl font-bold text-slate-100 mb-3">{title}</h3>
      <p className="text-slate-400 mb-4 leading-relaxed">{desc}</p>

      {integration && (
        <div className={`mt-4 p-4 rounded-xl text-sm border ${colorStyles[color]} ${textStyles[color]}`}>
          <div className="font-semibold mb-1 flex items-center gap-1.5">
            <span className="text-lg animate-pulse">✦</span> 整合資料
          </div>
